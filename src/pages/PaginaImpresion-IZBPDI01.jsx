...
import { isTauri } from '../tauriSafe'; // Importa la función que acabas de crear
import { getCurrentWindow } from '@tauri-apps/api/window'; // Usamos esta API si la necesitas
import React, { useState, useEffect } from 'react';
import TicketCompra from '../components/TicketCompra'; // Importar el componente de ticket
    ...
    if (ticket) {
      ...
      const timer = setTimeout(() => {
        ...
        const handleAfterPrint = () => {
          // Verificar si estamos en Tauri antes de ejecutar
          if (isTauri) {
